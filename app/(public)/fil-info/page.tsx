      ...
      <section className="mx-auto max-w-7xl px-5 py-10 sm:px-6 md:px-10 md:py-16">
        ...
        {briefs.length > 0 && (
          ...
          >
            ...
            <div className="grid auto-rows-[220px] md:grid-cols-3">
              {briefs.map((article, index) => (
                ...
                >
                  <article className="flex h-[220px] flex-col justify-between overflow-hidden py-6">
                    <div>
          ...
          <div className="mt-8 grid items-stretch gap-12 md:mt-12 lg:grid-cols-6 lg:gap-14">
            {cards.length > 0 && (
              <section
                ...
                className="flex min-h-[720px] flex-col lg:h-[980px] lg:overflow-hidden lg:col-span-4"
              >
