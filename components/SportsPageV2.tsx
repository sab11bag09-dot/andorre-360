          ...
          <aside className="space-y-6 lg:col-span-2">
            ...
            {questionArticle && (
              <Link
                ...
                className="block"
              >
                <article className="flex h-[520px] flex-col overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500">
                  {questionImage ? (
                  ...
                  <div className="flex min-h-0 flex-1 flex-col justify-between overflow-hidden p-4">
            ...
            {rightCards.map((article) => (
              <Link
                ...
                className="block"
              >
                <article className="flex h-[240px] flex-col overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500">
                  {article.image ? (
            ...
            {bonASavoir && (
              <Link
                ...
                className="block"
              >
                <article className="h-[300px] overflow-hidden rounded-xl border-t-2 border-yellow-500 bg-zinc-900 p-6 transition hover:bg-zinc-800">
                  <p className="text-xs font-semibold uppercase tracking-[0.25em] text-yellow-500">
                    Bon à savoir
                  </p>
