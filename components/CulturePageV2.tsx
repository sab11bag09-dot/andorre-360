...
export default async function CulturePageV2() {
              ...
              <div className="mt-10 grid gap-8 md:grid-cols-2">
                {bottomCard && (
                  <Link
                    ...
                    className="block"
                  >
                    <article className="overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500 lg:flex lg:flex-col">
          ...
          <aside className="space-y-6 lg:col-span-2">
            ...
            {bonASavoir && (
              <Link
                ...
                className="block"
              >
                <article className="h-[260px] overflow-hidden rounded-xl border-t-2 border-yellow-500 bg-zinc-900 p-6 transition hover:bg-zinc-800">
                  <p className="text-xs font-semibold uppercase tracking-[0.25em] text-yellow-500">
                    Bon à savoir
                  </p>
