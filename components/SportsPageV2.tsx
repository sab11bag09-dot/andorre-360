          ...
          <aside className="space-y-6 lg:col-span-2">
            ...
            {rightCards.map((article) => (
              <Link
                ...
                className="block"
              >
                <article className={article.title.toLowerCase().includes("basket") ? "h-[400px] overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500" : "overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500"}>
                  {article.image ? (
