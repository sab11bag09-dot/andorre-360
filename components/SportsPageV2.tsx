                  ...
                  >
                    <article className="flex h-[460px] flex-col overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500">
                      ...
                      <div className="flex min-h-0 flex-1 flex-col overflow-hidden p-5">
                        ...
                        <p className="mt-3 line-clamp-2 h-12 max-h-12 overflow-hidden text-sm leading-6 text-gray-400">
                          {article.description}
                        </p>
              ...
              <Link href={`/article/${questionArticle.slug}`} className="block">
                <article className="overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500">
                  ...
                  <div className="p-4">
                    ...
                    <p className="mt-3 line-clamp-3 h-[4.5rem] max-h-[4.5rem] overflow-hidden text-sm leading-6 text-gray-400">
            ...
            {rightCards.map((article, index) => (
              ...
              >
                <article className="h-full overflow-hidden rounded-xl border border-gray-800 transition hover:border-yellow-500 lg:flex lg:flex-col">
                  ...
                  <div className="p-4">
                    <h3 className="line-clamp-3 h-[4.5rem] max-h-[4.5rem] overflow-hidden font-serif text-lg leading-6">
                      {article.title}
                    </h3>
