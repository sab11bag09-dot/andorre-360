...
<section className="border-t-2 border-yellow-500 pt-5">
  ...
  <div className="divide-y divide-gray-800">
    {cards.slice(0, 5).map((article, index) => (
      ...
      <section className="mx-auto -mt-32 max-w-7xl px-6 pb-14 md:px-10 lg:ml-auto lg:mr-auto">
        <div className="w-full overflow-hidden border-y border-gray-800 bg-white lg:w-2/3">
          <img
